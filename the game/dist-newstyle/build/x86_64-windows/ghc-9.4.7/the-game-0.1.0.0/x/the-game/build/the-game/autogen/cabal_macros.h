...
/* package the-game-0.1.0.0 */
#ifndef VERSION_the_game
#define VERSION_the_game "0.1.0.0"
#endif /* VERSION_the_game */
#ifndef MIN_VERSION_the_game
#define MIN_VERSION_the_game(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_the_game */
...
#define CURRENT_COMPONENT_ID "the-game-0.1.0.0-inplace-the-game"
